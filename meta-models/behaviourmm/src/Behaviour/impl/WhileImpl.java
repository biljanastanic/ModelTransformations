 ...
 * <ul>
 *   <li>{@link Behaviour.impl.WhileImpl#getCheckWhile <em>Check While</em>}</li>
 *   <li>{@link Behaviour.impl.WhileImpl#getDoWhile <em>Do While</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class WhileImpl extends OperationImpl implements While {
	...
	protected EClass eStaticClass() {
		return BehaviourPackage.Literals.WHILE;
	}
	...
	public EList<Condition> getCheckWhile() {
		if (checkWhile == null) {
			checkWhile = new EObjectContainmentEList<Condition>(Condition.class, this, BehaviourPackage.WHILE__CHECK_WHILE);
		}
		return checkWhile;
	}
	...
	public EList<Body> getDoWhile() {
		if (doWhile == null) {
			doWhile = new EObjectContainmentEList<Body>(Body.class, this, BehaviourPackage.WHILE__DO_WHILE);
		}
		return doWhile;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case BehaviourPackage.WHILE__CHECK_WHILE:
				return ((InternalEList<?>)getCheckWhile()).basicRemove(otherEnd, msgs);
			case BehaviourPackage.WHILE__DO_WHILE:
