...
/**
 * This is the item provider adapter for a {@link Structure.Attribute} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AttributeItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Attribute_attributeName_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Attribute_attributeName_feature", "_UI_Attribute_type"),
				 StructurePackage.Literals.ATTRIBUTE__ATTRIBUTE_NAME,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 StructurePackage.Literals.ATTRIBUTE__ATTRIBUTE_TYPE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addAttributeValuePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Attribute_attributeValue_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Attribute_attributeValue_feature", "_UI_Attribute_type"),
				 StructurePackage.Literals.ATTRIBUTE__ATTRIBUTE_VALUE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		String label = ((Attribute)object).getAttributeName();
