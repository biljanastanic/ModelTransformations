...
/**
 * This is the item provider adapter for a {@link Structure.Class} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ClassItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(StructurePackage.Literals.CLASS__HAVE);
			childrenFeatures.add(StructurePackage.Literals.CLASS__DO);
		}
	...
	public String getText(Object object) {
		String label = ((Structure.Class)object).getName();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Structure.Class.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(StructurePackage.Literals.CLASS__HAVE,
				 StructureFactory.eINSTANCE.createAttribute()));

		newChildDescriptors.add
			(createChildParameter
				(StructurePackage.Literals.CLASS__DO,
				 StructureFactory.eINSTANCE.createAbstractMethod()));
	}
