...
public class StructureSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case StructurePackage.CLASS: {
				Structure.Class class_ = (Structure.Class)theEObject;
			...
			case StructurePackage.ABSTRACT_METHOD: {
			...
			case StructurePackage.PACKAGE: {
				Structure.Package package_ = (Structure.Package)theEObject;
	 ...
	 * @generated
	 */
	public T caseClass(Structure.Class object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T casePackage(Structure.Package object) {
		return null;
	}
