...
/**
 * This is the item provider adapter for a {@link StructuralBehavior.Body} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BodyItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Body_operations_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Body_operations_feature", "_UI_Body_type"),
				 StructuralBehaviorPackage.Literals.BODY__OPERATIONS,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Body)object).getOperations();
