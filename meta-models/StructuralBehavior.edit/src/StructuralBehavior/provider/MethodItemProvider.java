...
/**
 * This is the item provider adapter for a {@link StructuralBehavior.Method} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MethodItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Method_methodName_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Method_methodName_feature", "_UI_Method_type"),
				 StructuralBehaviorPackage.Literals.METHOD__METHOD_NAME,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 StructuralBehaviorPackage.Literals.METHOD__RETURN_TYPE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addMethodVisibilityPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Method_methodVisibility_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Method_methodVisibility_feature", "_UI_Method_type"),
				 StructuralBehaviorPackage.Literals.METHOD__METHOD_VISIBILITY,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(StructuralBehaviorPackage.Literals.METHOD__INPUT);
			childrenFeatures.add(StructuralBehaviorPackage.Literals.METHOD__CONTAIN);
		}
	...
	public String getText(Object object) {
		String label = ((Method)object).getMethodName();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(StructuralBehaviorPackage.Literals.METHOD__INPUT,
				 StructuralBehaviorFactory.eINSTANCE.createAttribute()));

		newChildDescriptors.add
			(createChildParameter
				(StructuralBehaviorPackage.Literals.METHOD__CONTAIN,
				 StructuralBehaviorFactory.eINSTANCE.createAssignment()));

		newChildDescriptors.add
			(createChildParameter
				(StructuralBehaviorPackage.Literals.METHOD__CONTAIN,
				 StructuralBehaviorFactory.eINSTANCE.createWhile()));

		newChildDescriptors.add
			(createChildParameter
				(StructuralBehaviorPackage.Literals.METHOD__CONTAIN,
				 StructuralBehaviorFactory.eINSTANCE.createIf()));
	}
	...
	public ResourceLocator getResourceLocator() {
		return StructuralBehaviorEditPlugin.INSTANCE;
	}
