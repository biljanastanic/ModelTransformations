 ...
 * <ul>
 *   <li>{@link StructuralBehavior.impl.IfImpl#getCheckIf <em>Check If</em>}</li>
 *   <li>{@link StructuralBehavior.impl.IfImpl#getDoIf <em>Do If</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class IfImpl extends OperationImpl implements If {
	...
	protected EClass eStaticClass() {
		return StructuralBehaviorPackage.Literals.IF;
	}
	...
	public EList<Condition> getCheckIf() {
		if (checkIf == null) {
			checkIf = new EObjectContainmentEList<Condition>(Condition.class, this, StructuralBehaviorPackage.IF__CHECK_IF);
		}
		return checkIf;
	}
	...
	public EList<Body> getDoIf() {
		if (doIf == null) {
			doIf = new EObjectContainmentEList<Body>(Body.class, this, StructuralBehaviorPackage.IF__DO_IF);
		}
		return doIf;
	}
