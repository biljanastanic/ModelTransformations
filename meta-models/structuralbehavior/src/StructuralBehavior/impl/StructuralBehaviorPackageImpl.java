 ...
 * @generated
 */
public class StructuralBehaviorPackageImpl extends EPackageImpl implements StructuralBehaviorPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see StructuralBehavior.StructuralBehaviorPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private StructuralBehaviorPackageImpl() {
		super(eNS_URI, StructuralBehaviorFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link StructuralBehaviorPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static StructuralBehaviorPackage init() {
		if (isInited) return (StructuralBehaviorPackage)EPackage.Registry.INSTANCE.getEPackage(StructuralBehaviorPackage.eNS_URI);

		// Obtain or create and register package
		StructuralBehaviorPackageImpl theStructuralBehaviorPackage = (StructuralBehaviorPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof StructuralBehaviorPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new StructuralBehaviorPackageImpl());

		isInited = true;

		// Create package meta-data objects
		theStructuralBehaviorPackage.createPackageContents();

		// Initialize created meta-data
		theStructuralBehaviorPackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theStructuralBehaviorPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(StructuralBehaviorPackage.eNS_URI, theStructuralBehaviorPackage);
		return theStructuralBehaviorPackage;
	}
	 ...
	 * @generated
	 */
	public EReference getClass_Have() {
	 ...
	 * @generated
	 */
	public EReference getMethod_Contain() {
	 ...
	 * @generated
	 */
	public EAttribute getMethod_MethodVisibility() {
	 ...
	 * @generated
	 */
	public EAttribute getAssignment_VaribleType() {
	 ...
	 * @generated
	 */
	public EReference getPackage_Composed() {
	 ...
	 * @generated
	 */
	public StructuralBehaviorFactory getStructuralBehaviorFactory() {
		return (StructuralBehaviorFactory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		createEReference(classEClass, CLASS__HAVE);
		createEReference(classEClass, CLASS__DO);
		...
		createEReference(methodEClass, METHOD__CONTAIN);
		createEAttribute(methodEClass, METHOD__METHOD_VISIBILITY);
		...
		createEAttribute(assignmentEClass, ASSIGNMENT__VARIBLE_TYPE);
		...
		createEReference(packageEClass, PACKAGE__COMPOSED);
	}
	...
	public void initializePackageContents() {
		...
		initEClass(classEClass, StructuralBehavior.Class.class, "Class", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getClass_Name(), ecorePackage.getEString(), "name", null, 1, 1, StructuralBehavior.Class.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getClass_Have(), this.getAttribute(), null, "Have", null, 0, -1, StructuralBehavior.Class.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getClass_Do(), this.getMethod(), null, "Do", null, 0, -1, StructuralBehavior.Class.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(methodEClass, Method.class, "Method", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getMethod_MethodName(), ecorePackage.getEString(), "methodName", null, 1, 1, Method.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getMethod_Input(), this.getAttribute(), null, "Input", null, 0, -1, Method.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getMethod_Contain(), this.getOperation(), null, "Contain", null, 0, -1, Method.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getMethod_MethodVisibility(), ecorePackage.getEString(), "methodVisibility", null, 0, 1, Method.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getAttribute_AttributeType(), ecorePackage.getEString(), "attributeType", null, 0, 1, Attribute.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getAssignment_VaribleType(), ecorePackage.getEString(), "varibleType", null, 0, 1, Assignment.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEClass(packageEClass, StructuralBehavior.Package.class, "Package", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getPackage_Composed(), this.getClass_(), null, "Composed", null, 0, -1, StructuralBehavior.Package.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		// Create resource
		createResource(eNS_URI);
	}

} //StructuralBehaviorPackageImpl
